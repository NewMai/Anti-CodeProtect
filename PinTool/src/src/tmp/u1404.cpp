...
{
	GetLock(&fileLock, 1);
	unsigned char * buffer = (unsigned char *)PIN_GetContextReg( ctxt, REG_EAX );
	unsigned int len = PIN_GetContextReg( ctxt, REG_ECX );
